...
calc_route_bp = Blueprint("calc_routes", __name__) # Colocamos dentro um nome para as rotas das calculadoras
# Vou querer nomear todas as rotas relacionadas as calculadoras a partir da variável, isso para saber quais são as rotas que estão associadas as calculadoras 
